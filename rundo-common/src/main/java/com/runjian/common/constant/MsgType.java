...
public enum MsgType {
    ...
    DEVICE_PLATFORM_SUBSCRIBE("DEVICE_PLATFORM_SUBSCRIBE", false),
    DEVICE_DELETE_RECOVER("DEVICE_DELETE_RECOVER", false),
    DEVICE_NODE_SYNC("DEVICE_NODE_SYNC", false),
    DEVICE_CHANNEL_SUBSCRIBE("DEVICE_CHANNEL_SUBSCRIBE", false),
    DEVICE_NODE_SUBSCRIBE("DEVICE_NODE_SUBSCRIBE", false),
    /****************** 通道相关消息 ******************/
