 ...
 */
@Service
public class HwDeviceNetSdkNorthProtocol extends AbstractNorthProtocol {

    public HwDeviceNetSdkNorthProtocol(GatewayTaskService gatewayTaskService, DataBaseService dataBaseService, DeviceMapper deviceMapper, ChannelMapper channelMapper) {
        super(gatewayTaskService, dataBaseService, deviceMapper, channelMapper);
    }

    @Override
    public String getProtocolName() {
        return "HW-DEVICE_NET_SDK_V6";
    }
